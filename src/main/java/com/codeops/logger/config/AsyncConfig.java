...
/**
 * Configures the asynchronous task execution infrastructure for CodeOps-Logger.
 *
 * <p>Provides a {@link ThreadPoolTaskExecutor} with a core pool of 2 threads, a maximum of 5,
 * and a queue capacity of 100. Threads are named with the {@code logger-async-} prefix.
...
public class AsyncConfig implements AsyncConfigurer {
    ...
    public Executor getAsyncExecutor() {
        ...
        executor.setThreadNamePrefix("logger-async-");
